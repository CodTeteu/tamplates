        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-20">
            ...
            <button
              ...
              className={`font-script text-3xl transition-all duration-300 hover:scale-105 ${
                isScrolled ? "text-primary" : "text-background drop-shadow-lg"
              }`}
            >
              E & N
            </button>
            ...
            <div className="hidden lg:flex items-center gap-10">
              {navItems.map((item) => (
                <button
                  ...
                  className={`font-body text-xs uppercase tracking-[0.15em] transition-all duration-300 hover:text-primary relative group ${
